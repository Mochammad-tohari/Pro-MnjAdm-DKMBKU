...
<head>
    ...
    <title>Pendaftaran Murid Selesai</title>
</head>

<body>
    <h1>Terima Kasih, Pendaftaran Murid Telah Selesai!</h1>

    <h2>Berikut adalah informasi pendaftaran murid:</h2>

    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card" id="murid_madrasah_pendaftar">
                    ...
                    <div class="card-Body">
                        <ul>
                            <li><strong>Kode Murid :</strong> {{ $Kode_Murid }}</li>
                            <li><strong>Nama Murid :</strong> {{ $Nama_Murid }}</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function takeScreenshot() {
            ...
            var element = document.getElementById('murid_madrasah_pendaftar');
            ...
            html2canvas(element).then(function(canvas) {
                ...
                var fileName = '{{ $Nama_Murid }} ' + 'Murid_Pendaftar.png';
