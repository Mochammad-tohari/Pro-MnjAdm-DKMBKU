...
class inventaris_controller extends Controller
{
    ...
    public function inventaris_export_pdf()
    {
        $inventaris_data = inventaris_model::orderBy('Nama_Inventaris', 'asc')->get();

        view()->share('inventaris_data', $inventaris_data);
        $inventaris_pdf = PDF::loadview('inventaris_export-pdf');
        return $inventaris_pdf->download('data_inventaris.pdf');
