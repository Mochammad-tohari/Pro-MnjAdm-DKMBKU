    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Data Bidang Nawa</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active"> <a href="/bidang_nawa_data">Data Bidang Nawa</a></li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <div class="col-auto">
            <div class="card col-auto">
                <div class="card-header col-auto">
                    <h3 class="card-title text-center">Daftar Data Bidang Nawa</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body col-auto">
                    ...
                    @endif --}}
                    @if (auth()->user()->akses === 'Admin')
                        <a button type="button" class="btn btn-success" href="/bidang_nawa_create">Tambah Data</button>
                        </a>
                    @endif
        ...
        @endif --}}
                        ...
                        <style>
                            ...
                            table.table-bidang_nawa thead tr {
                            ...
                            table.table-bidang_nawa tbody tr:nth-child(odd) {
                                background-color: #343A40;
                                /* Lighter color for odd rows */
                            }

                            table.table-bidang_nawa tbody tr:nth-child(even) {
                                background-color: #3e454d;
                                /* Default color for even rows */
                            }

                            table.table-bidang_nawa th,
                            table.table-bidang_nawa td {
                                color: #ffffff;
                        ...
                        <div class="table-container">
                            <table class="table-bidang_nawa table-bordered mt-3">
                                <thead>
                                    <tr>
                                        <th scope="col">Nomor</th>
                                        <th scope="col">Kode Bidang Nawa</th>
                                        <th scope="col">Nama Bidang Nawa</th>
                                        <th scope="col">Keterangan Bidang Nawa</th>
                                        <th scope="col">Status Bidang Nawa</th>
                                ...
                                <tbody>
                                    <tr>
                                        @foreach ($bidang_nawa_data as $bidang_nawa_index => $row)
                                    <tr>
                                        <!-- daftar nomor urut -->
                                        <td>{{ $bidang_nawa_index + $bidang_nawa_data->firstItem() }}</td>
                                        ...
                                        <td>
                                            @if (auth()->user()->akses === 'Admin')
                                                <a href="/bidang_nawa_edit/{{ $row->id_bidang_nawa }}"
