...
<body>
            ...
            <div class="col-md-5">
                <div class="card text-center" id="inventaris-card" data-bs-theme="light">
                    ...
                    <div class="card-Body text-start" style="padding-left: 20px;">
                        <p><strong>Kode Inventaris :</strong> {{ $inventaris_data->Kode_Inventaris }}</p>
                        <p><strong>Nama Inventaris :</strong> {{ $inventaris_data->Nama_Inventaris }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        function takeScreenshot() {
            ...
            var element = document.getElementById('inventaris-card');
            ...
            html2canvas(element).then(function(canvas) {
                ...
                // mengatur file download sesuai dengan nilai Nama_Inventaris
                var fileName = '{{ $inventaris_data->Nama_Inventaris }}' + '_INVS.png';
