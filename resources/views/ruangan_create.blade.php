...
<div>
        ...
        <div class="card-body col-auto">
          <div class="card-body">
            <form action="/ruangan_insert" method="POST" enctype="multipart/form-data">
               ...
               <form>
                 <div class="card-body mb-3">
                   ...
                   <div class="form-group mb-3">
                       <label for="id" class="form-label">Nama Gedung</label>
                        <select class="custom-select rounded-0" id="" name="Gedung_Kode" >
                            ...
                            @foreach ($gedungOptions as $Kode_Gedung => $Nama_Gedung)
                            <option value="{{ $Kode_Gedung }}">
                                {{ $Nama_Gedung }}
                            </option>
                        @endforeach
                        </select>
                   ...
                   <div class="form-group mb-3">
                       ...
                       <input type="text" class="form-control" placeholder="" id="" name="Nama_Ruangan">
                   </div>
                   ...
                   <div class="form-group mb-3">
                       ...
                       <input  class="form-control" type="date" id="" name="Tanggal_Operasional_Ruangan" />
                   </div>
