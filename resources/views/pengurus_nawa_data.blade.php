...
@section('content')
    <title>Data Pengurus Nawa</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Data Pengurus Nawa</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active"><a href="/pengurus_nawa_data">Data Pengurus Nawa</a></li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <div class="col-auto">
            <div class="card col-auto">
                <div class="card-header col-auto">
                    <h3 class="card-title text-center">Daftar Data Pengurus Nawa</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body col-auto">
                    ...
                    @if (auth()->user()->akses === 'Admin')
                        <a button type="button" class="btn btn-success" href="/pengurus_nawa_create">Tambah Data</button>
                        </a>
                    @endif
        ...
        @endif --}}
                        ...
                        <style>
                            ...
                            table.table-pengurus_nawa thead tr {
                            ...
                            table.table-pengurus_nawa tbody tr:nth-child(odd) {
                                background-color: #343A40;
                                /* Lighter color for odd rows */
                            }

                            table.table-pengurus_nawa tbody tr:nth-child(even) {
                                background-color: #3e454d;
                                /* Default color for even rows */
                            }

                            table.table-pengurus_nawa th,
                            table.table-pengurus_nawa td {
                                color: #ffffff;
                        ...
                        <div class="table-container">
                            <table class="table-pengurus_nawa table-bordered mt-3">
                                <thead>
                                    <tr>
                                        <th scope="col">Nomor</th>
                                        <th scope="col">Kode Pengurus Nawa</th>
                                        <th scope="col">NIP Pengurus Nawa</th>
                                        <th scope="col">Jabatan Pengurus Nawa</th>
                                        <th scope="col">Nama Pengurus Nawa</th>
                                        <th scope="col">Kontak Pengurus Nawa</th>
                                        <th scope="col">Alamat Pengurus Nawa</th>
                                        <th scope="col">Foto Pengurus Nawa</th>
                                        <th scope="col">Identitas Pengurus Nawa</th>
                                        <th scope="col">Keterangan Pengurus Nawa</th>
                                        <th scope="col">Status Pengurus Nawa</th>
                                ...
                                <tbody>
                                    <tr>
                                        @foreach ($pengurus_nawa_data as $pengurus_nawa_index => $row)
                                    <tr>
                                        <!-- daftar nomor urut -->
                                        <td>{{ $pengurus_nawa_index + $pengurus_nawa_data->firstItem() }}</td>
                                        ...
                                        @if (auth()->user()->akses === 'Admin')
                                            <td>
                                                @if ($row->Foto_Pengurus_Nawa)
                                                    <img src="{{ asset('Data_Pengurus_Nawa/Foto_Pengurus_Nawa/' . $row->Foto_Pengurus_Nawa) }}"
                                                        alt="Foto_Pengurus_Nawa" style="width: 40px;">
                                                @endif
                                            </td>


                                            <td>
                                                @if ($row->Identitas_Pengurus_Nawa)
                                                    <img src="{{ asset('Data_Pengurus_Nawa/Identitas_Pengurus_Nawa/' . $row->Identitas_Pengurus_Nawa) }}"
                                                        alt="Identitas_Pengurus_Nawa" style="width: 40px;">
                                                @endif
                                            </td>
                                        @endif
                                        ...
                                        <td>
                                            @if (auth()->user()->akses === 'Admin')
                                                <a href="/pengurus_nawa_edit/{{ $row->id_pengurus_nawa }}"
                                                    class="btn btn-primary btn-sm"><i class="fas fa-pen"></i>Edit</a>
                                            @endif
                                            <a href="/pengurus_nawa_view/{{ $row->id_pengurus_nawa }}" target="_blank"
