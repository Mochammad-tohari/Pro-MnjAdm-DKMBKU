...
@section('content')
    ...
    <title>Tambah Bidang Nawa</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Tambah Bidang Nawa</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/bidang_nawa_data">Bidang Nawa</a></li>
                            <li class="breadcrumb-item active">Tambah Bidang Nawa</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <div>
            ...
            <div class="card-body col-auto">
                <div class="card-body">
                    <form action="/bidang_nawa_insert" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header mb-3">
                                        <h3 class="card-title">Tambah Bidang Nawa</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form>
                                        <div class="card-body mb-3">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder=""
                                                    value="BDNW-<?php echo $tgl; ?>" id="Kode_Bidang_Nawa"
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder=""
                                                    ...
                                                    value="{{ old('Nama_Bidang_Nawa') }}">
                                                {{-- pemberitahuan validator --}}
                                                @error('Nama_Bidang_Nawa')
                                            ...
                                            <div class="form-group mb-3">
                                                <label for="Keterangan_Bidang_Nawa" class="form-label">Keterangan Bidang
                                                    Nawa</label>
                                                <textarea class="form-control" name="Keterangan_Bidang_Nawa" id="Keterangan_Bidang_Nawa">{{ old('Keterangan_Bidang_Nawa') }}</textarea>
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="custom-select rounded-0" id="Status_Bidang_Nawa"
                                                    ...
                                                    <option value="Aktif"
                                                        {{ old('Status_Bidang_Nawa') == 'Aktif' ? 'selected' : '' }}>Aktif
                                                    </option>
                                                    <option value="Tidak_Aktif"
                                                        {{ old('Status_Bidang_Nawa') == 'Tidak_Aktif' ? 'selected' : '' }}>
                                                        Tidak Aktif</option>
                                                    <option value="Lainya"
                                                        {{ old('Status_Bidang_Nawa') == 'Lainya' ? 'selected' : '' }}>
                                                        Lainya
                                                    </option>
                                                </select>
                                                {{-- pemberitahuan validator --}}
                                                @error('Status_Bidang_Nawa')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
