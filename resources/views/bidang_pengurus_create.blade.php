...
@section('content')
    ...
    <title>Tambah Bidang Pengurus</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Tambah Bidang Pengurus</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/bidang_pengurus_data">Bidang Pengurus</a></li>
                            <li class="breadcrumb-item active">Tambah Bidang Pengurus</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <div>
            ...
            <div class="card-body col-auto">
                <div class="card-body">
                    <form action="/bidang_pengurus_insert" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header mb-3">
                                        <h3 class="card-title">Tambah Bidang Pengurus</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form>
                                        <div class="card-body mb-3">
                                            ...
                                            <div class="card-footer mb-6">
                                                ...
                                                <a href="/bidang_pengurus_data" class="ml-2">
