...
class pengurus_dkm_controller extends Controller
{
    ...
    //export PDF
    public function pengurus_dkm_export_pdf()
    {

        $pengurus_dkm_data = pengurus_dkm_model::orderBy('Nama_Pengurus_DKM', 'asc')->get();

        view()->share('pengurus_dkm_data', $pengurus_dkm_data);
        $pengurus_dkm_pdf = PDF::loadview('pengurus_dkm_export-pdf');

        return $pengurus_dkm_pdf->download('data_pengurus_dkm.pdf');
