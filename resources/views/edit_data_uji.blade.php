                 ...
                 <div class="card-body mb-3">
                  ...
                  <div class="form-group mb-3">
                    <label for="Foto1" class="form-label">Foto Uji 1</label>
                      ...
                      <label for="Foto1" class="form-label">Kosongkan input jika tidak ada foto baru yang ingin diunggah</label>
                   </div>
                  <script>
                  ...
                  <div class="form-group mb-3">
                    <label for="Foto2" class="form-label">Foto Uji 2</label>
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="Foto2" name="Foto2" value="{{$data_uji->Foto1}}">
                        <label class="custom-file-label" for="exampleInputFile">Pilih Foto 2</label>
                      </div>
                      <label for="Foto2" class="form-label">Kosongkan input jika tidak ada foto baru yang ingin diunggah</label>
                  </div>
                  <script>
