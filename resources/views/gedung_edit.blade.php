...
<div>
        ...
        <div class="card-body col-auto">
          <div class="card-body">
            <form action="/gedung_update/{{$gedung_data->id_gedung}}" method="POST" enctype="multipart/form-data">
                 ...
                 <div class="card-body mb-3">
                   ...
                   <div class="form-group mb-3">
                       ...
                       <?php
                           $tgl = date ('ymdGis');
                       ?>
                          <input type="text" class="form-control" placeholder=""  value="{{$gedung_data->Kode_Gedung}}" id="" name="Kode_Gedung" readonly>
                          <div name="" class="form-text">Tidak Bisa Diubah</div>
                   </div>

                   <div class="form-group mb-3">
                       <label for="Nama_Gedung" class="form-label">Nama Gedung</label>
                       <input type="text" class="form-control" placeholder="" id="" name="Nama_Gedung" value="{{$gedung_data->Nama_Gedung}}">
                   </div>

                   <div class="form-group mb-3">
                       <label for="Dimensi_Gedung" class="form-label">Dimensi Gedung</label>
                       <textarea class="form-control" name="Dimensi_Gedung" >{{$gedung_data->Dimensi_Gedung}}</textarea>
                   </div>

                   <div class="form-group mb-3">
                       <label for="Tanggal_Operasional_Gedung" class="form-label">Tanggal Operasional Gedung</label>
                       <input  class="form-control" type="date" id="" name="Tanggal_Operasional_Gedung" value="{{$gedung_data->Tanggal_Operasional_Gedung}}">
                   </div>

                   <div class="form-group mb-3">
                       <label for="Keterangan_Gedung" class="form-label">Keterangan Gedung</label>
                       <textarea class="form-control" name="Keterangan_Gedung">{{$gedung_data->Keterangan_Gedung}}</textarea>
                   </div>

                   <div class="form-group mb-3">
                    <label for="Status_Gedung">Status_Gedung</label>
                    <select class="custom-select rounded-0" id="" name="Status_Gedung">
                        <option selected disabled value>{{$gedung_data->Status_Gedung }}</option>
