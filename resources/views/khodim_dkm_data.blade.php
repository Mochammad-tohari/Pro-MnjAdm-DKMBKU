            ...
            <div style="overflow-x: auto;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$row->Jabatan_Khodim}}</td>
                        <td>{{$row->Nama_Khodim}}</td>
                        <td>{{$row->Kontak_Khodim}}</td>
                        <td>{{$row->Alamat_Khodim}}</td>

                        <td>{{$row->Foto_Khodim}}</td>

                        @if(auth()->user()->akses === 'Admin')
                        <td>{{$row->Identitas_Khodim}}</td>
                        @endif
                        ...
                        <td>
                        @if(auth()->user()->akses === 'Admin')
                        <a href="/khodim_dkm_edit/{{$row->id_khodim_dkm}}" class="btn btn-primary btn-sm"><i class="fas fa-pen"></i>Edit</a>
                        @endif
                        <a href="/khodim_dkm_view/{{$row->id_khodim_dkm}}" target="_blank" class="btn btn-secondary btn-sm mt-2"><i class="fas fa-eye"></i>Lihat</a>
